...
void DEMO_Render(double deltatime)
{
	...
	// render the object
	if (wireframe_mode == 1)
		Draw_RENDERLIST4DV1_Wire(&rend_list, framebuffer, framebuffer_pitch);
	else
		Draw_RENDERLIST4DV1_Solid2(&rend_list, framebuffer, framebuffer_pitch);
