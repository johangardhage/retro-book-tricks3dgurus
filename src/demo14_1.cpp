...
void DEMO_Render(double deltatime)
{
	...
	// draw the sky
	Draw_Rectangle16(0, 0, screen_width, screen_height, RGB16Bit(255, 120, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
		...
		"assets/grass256_256_02.bmp", //"checker2562562.bmp",   // filename of texture map
