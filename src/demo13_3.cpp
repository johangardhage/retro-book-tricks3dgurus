...
void DEMO_Render(double deltatime)
{
	...
	case EDITOR_STATE_EDIT: /////////////////////////////////////////////////
	{
		...
		if (KEY_DOWN(VK_ESCAPE) || RETRO_KeyPressed(SDL_SCANCODE_ESCAPE)) {
	...
	case EDITOR_STATE_VIEW: ///////////////////////////////////////////////
	{
	   ...
	   // generate rotation matrix around y axis
		...
		if (help_mode == 1) {
			...
			Draw_Text_GDI16("<C>..............Toggle BSP Backface Culling.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	// load the object in
	Load_OBJECT4DV2_COB2(&obj_scene, "assets/cube_flat_textured_01.cob",
