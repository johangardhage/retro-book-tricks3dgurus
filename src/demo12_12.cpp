...
const char *object_filenames[NUM_OBJECTS] = { "assets/sphere_bw01.cob",
										"assets/cube_constant_textured_01.cob",
...
//	Draw_Rectangle16(0, screen_height * .5, screen_width, screen_height, RGB16Bit(190, 190, 230), framebuffer, framebuffer_pitch);
	...
	if (help_mode == 1) {
		...
		Draw_Text_GDI16("<N>..............Enable next rendering pass.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
		...
		"assets/checkerheight05.bmp",  // filename of height bitmap encoded in 256 colors
	...
	Load_OBJECT4DV2_COB2(&obj_terrain, "assets/plane01.cob",
