...
typedef struct OBJECT4DV2_TYP
{
	...
	char  name[128];     // ASCII name of object just for kicks
...
void Transform_OBJECT4DV2(OBJECT4DV2_PTR obj,  // object to transform
	...
	int transform_basis, // flags if vector orientation should be transformed too
	int all_frames = 0)      // should all frames be transformed
{
...
int Load_OBJECT4DV2_COB(OBJECT4DV2_PTR obj,   // pointer to object
	...
	int vertex_flags = 0)     // flags to re-order vertices and perform transforms
{
...
//									Load_Bitmap_File(&bitmap16bit, path_filename);
									Load_Bitmap_File(&bitmap16bit, materials[material_index + num_materials].texture_file);
...
int Load_OBJECT4DV2_3DSASC(OBJECT4DV2_PTR obj,   // pointer to object
	...
	VECTOR4D_PTR pos,     // initial position
	VECTOR4D_PTR rot,     // initial rotations
	int vertex_flags = 0)     // flags to re-order vertices a and shading overrides
{
...
int Load_OBJECT4DV2_PLG(OBJECT4DV2_PTR obj, // pointer to object
	...
	VECTOR4D_PTR pos,       // initial position
	VECTOR4D_PTR rot,       // initial rotations
	int vertex_flags = 0)       // vertex flags, used to override
{
