...
public:
	...
	int Pattern_Match(char *string, const char *pattern, ...);
...
int CPARSERV1::Pattern_Match(char *string, const char *pattern, ...)
{
...
int ReplaceChars(char *string_in, char *string_out, const char *replace_chars, char rep_char, int case_on = 1)
{
