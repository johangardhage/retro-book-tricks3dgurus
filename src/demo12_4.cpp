...
//		Draw_Bitmap16(&background_bmp, framebuffer, framebuffer_pitch, 0);
		...
		if (help_mode == 1) {
			...
			Draw_Text_GDI16("<T>..............Toggle Sea floor.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Generate_Terrain2_OBJECT4DV2(&obj_terrain2,            // pointer to object
		...
		"assets/heightmap02.bmp",  // filename of height bitmap encoded in 256 colors
		"assets/seabottom_01.bmp",   // filename of texture map
		RGB16Bit(255, 255, 255),  // color of terrain if no texture        
		&terrain_pos,           // initial position
		NULL,                   // initial rotations
		POLY4DV2_ATTR_RGB16
	...
	Load_OBJECT4DV2_COB2(&obj_player, "assets/jetski06.cob",
	...
	Load_Bitmap_File(&bitmap16bit, "assets/cloud03_640.bmp");
