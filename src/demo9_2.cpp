...
void DEMO_Initialize(void)
{
	...
	Load_OBJECT4DV2_COB(&obj_constant_water, "assets/water_constant_01.cob",
	...
	VECTOR4D_INITXYZ(&vscale, 10.00, 10.00, 10.00);
	Load_OBJECT4DV2_COB(&obj_flat_water, "assets/water_flat_01.cob",
		&vscale, &vpos, &vrot, VERTEX_FLAGS_SWAP_YZ |
		VERTEX_FLAGS_TRANSFORM_LOCAL |
		VERTEX_FLAGS_TRANSFORM_LOCAL_WORLD);
	...
	VECTOR4D_INITXYZ(&vscale, 10.00, 10.00, 10.00);
	Load_OBJECT4DV2_COB(&obj_gouraud_water, "assets/water_gouraud_01.cob",
		&vscale, &vpos, &vrot, VERTEX_FLAGS_SWAP_YZ |
		VERTEX_FLAGS_TRANSFORM_LOCAL |
		VERTEX_FLAGS_TRANSFORM_LOCAL_WORLD);
