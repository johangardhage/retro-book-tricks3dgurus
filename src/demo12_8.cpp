...
void DEMO_Render(double deltatime)
{
	...
	// draw the sky
	Draw_Rectangle16(0, 0, screen_width, screen_height, RGB16Bit(50, 50, 255), framebuffer, framebuffer_pitch);
	...
	if (help_mode == 1) {
		...
		Draw_Text_GDI16("<1>,<2>..........Decrease/Increase Z-Distance 1.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
		Draw_Text_GDI16("<3>,<4>..........Decrease/Increase Z-Distance 2.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
		...
		"assets/checkerheight03.bmp",   // filename of height bitmap encoded in 256 colors
		"assets/checker256256.bmp",     // filename of texture map
