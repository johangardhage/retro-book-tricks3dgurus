...
void DEMO_Render(double deltatime)
{
	...
	static const char *perspective_modes[3] = { "AFFINE", "LINEAR PIECEWISE", "PERSPECTIVE CORRECT" };
	...
	if (help_mode == 1) {
		...
		Draw_Text_GDI16("<T>..............Select thru texturing modes.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
		...
		"assets/checker2562562.bmp",   // filename of texture map
