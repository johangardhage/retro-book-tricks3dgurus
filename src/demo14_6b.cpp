...
void DEMO_Initialize(void)
{
	...
	Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
		...
		"assets/heighlightmap_01.bmp",  // filename of height bitmap encoded in 256 colors
		"assets/sandstone256_256_01.bmp", // "grass256_256_01.bmp", //"checker2562562.bmp",   // filename of texture map
	...
	for (int index = 0; index < NUM_LIGHTMAPS; index++) {
		sprintf(buffer, "assets/fanlightmaps_0%dc.bmp", index + 1);
