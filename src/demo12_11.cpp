...
const char *object_filenames[NUM_OBJECTS] = { "assets/cube_constant_textured_01.cob",
										"assets/cube_constant_textured_02.cob",
										"assets/fire_constant_cube01.cob",
										"assets/borg_cube_constant01.cob",
...
//	Draw_Rectangle16(0, screen_height * .5, screen_width, screen_height, RGB16Bit(190, 190, 230), framebuffer, framebuffer_pitch);
	...
	if (help_mode == 1) {
		...
		Draw_Text_GDI16("<B>..............Toggle Bilinear Filtering.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
		Draw_Text_GDI16("<M>..............Toggle Mip Mapping.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
		Draw_Text_GDI16("<1>, <2>.........Decrease/Increase Mipdistance.", 0, text_y += 12, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
	...
	Draw_Text_GDI16(work_string, 0, screen_height - 34 - 32, RGB16Bit(0, 255, 0), framebuffer, framebuffer_pitch);

	sprintf(work_string, "CAM [%5.2f, %5.2f, %5.2f]", cam.pos.x, cam.pos.y, cam.pos.z);
	Draw_Text_GDI16(work_string, 0, screen_height - 34 - 48, RGB16Bit(0, 255, 0), framebuffer, framebuffer_pitch);
