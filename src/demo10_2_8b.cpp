...
void DEMO_Render(double deltatime)
{
	...
	// draw the sky
	Draw_Rectangle(0, 0, screen_width, screen_height * .38, rgblookup[RGB16Bit565(38, 168, 252)], framebuffer, framebuffer_pitch);

	// draw the ground
	Draw_Rectangle(0, screen_height * .38, screen_width, screen_height, rgblookup[RGB16Bit565(85, 85, 255)], framebuffer, framebuffer_pitch);
	...
	// draw cockpit
//	Draw_BOB(&cockpit, framebuffer, framebuffer_pitch);
	...
	Blit_Rect(src_rect, cockpit.images[0], cockpit.width, dest_rect, framebuffer, framebuffer_pitch, 0);
	...
	Draw_Text_GDI(work_string, 0, screen_height - 34 - 16, RGB(0, 255, 0), framebuffer, framebuffer_pitch);
	...
	if (help_mode == 1) {
		...
		Draw_Text_GDI("<X>..............Toggle X axis clipping.", 0, text_y += 12, RGB(255, 255, 255), framebuffer, framebuffer_pitch);
		Draw_Text_GDI("<Y>..............Toggle Y axis clipping.", 0, text_y += 12, RGB(255, 255, 255), framebuffer, framebuffer_pitch);
		Draw_Text_GDI("<Z>..............Toggle Z axis clipping.", 0, text_y += 12, RGB(255, 255, 255), framebuffer, framebuffer_pitch);
	...
	Draw_Text_GDI(work_string, 0, screen_height - 34 - 16 - 16, RGB(0, 255, 0), framebuffer, framebuffer_pitch);

	sprintf(work_string, "CAM [%5.2f, %5.2f, %5.2f], CELL [%d, %d]", cam.pos.x, cam.pos.y, cam.pos.z, cell_x, cell_y);

	Draw_Text_GDI(work_string, 0, screen_height - 34 - 16 - 16 - 16, RGB(0, 255, 0), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Load_Bitmap_File(&bitmap8bit, "assets/lego01_256.bmp");
	...
	Generate_Terrain_OBJECT4DV2(&obj_terrain,            // pointer to object
		...
		"assets/earthheightmap01.bmp",  // filename of height bitmap encoded in 256 colors
		"assets/earthcolormap01_256.bmp",   // filename of texture map
