...
void DEMO_Initialize(void)
{
	...
	Load_OBJECT4DV2_PLG(&obj_tank, "assets/tank3.plg", &vscale, &vpos, &vrot);

	// load player object for 3rd person view
	VECTOR4D_INITXYZ(&vscale, 15.75, 15.75, 15.75);
	Load_OBJECT4DV2_COB(&obj_player, "assets/tie04.cob",
	...
	Load_OBJECT4DV2_PLG(&obj_tower, "assets/towerg1.plg", &vscale, &vpos, &vrot);

	// load the master ground marker
	VECTOR4D_INITXYZ(&vscale, 3.0, 3.0, 3.0);
	Load_OBJECT4DV2_PLG(&obj_marker, "assets/marker2.plg", &vscale, &vpos, &vrot);
