...
void DEMO_Render(double deltatime)
{
	...
	// draw the sky
	Draw_Rectangle16(0, 0, screen_width, screen_height * .5, RGB16Bit(180, 180, 220), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Load_OBJECT4DV2_COB(&obj_scene, "assets/cube_gouraud_01.cob",
		&vscale, &vpos, &vrot, VERTEX_FLAGS_SWAP_YZ |
		VERTEX_FLAGS_TRANSFORM_LOCAL
	/* VERTEX_FLAGS_TRANSFORM_LOCAL_WORLD*/);
